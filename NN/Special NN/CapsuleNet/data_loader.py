...
class Dataset:
    def __init__(self, dataset, _batch_size):
        ...
        if dataset == 'mnist':
            ...
            train_dataset = datasets.MNIST(r"D:\editor\pythonProject\pythonProject1\datasets", train=True, download=False,
                                           transform=dataset_transform)
            test_dataset = datasets.MNIST(r"D:\editor\pythonProject\pythonProject1\datasets", train=False, download=False,
                                          transform=dataset_transform)
