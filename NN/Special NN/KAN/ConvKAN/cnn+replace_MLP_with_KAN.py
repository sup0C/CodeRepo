...
# CNN model for MNIST with KANLinear
...
if __name__ == '__main__':
    ...
    visualize_kan_parameters(model.kan1,"kan1")
    visualize_kan_parameters(model.kan2,"kan2")
